...
python3 train_roboy.py -hs 1024 -emb 300 -nl 1 -lr 0.1 -dr 0.2 -tr -1 -dec same -opt adam -ltim 5 -vtim 30 -vp 20 -vmt accuracy -vmm max -vcut 1.0 -dbf True -lfc False -stim 900 &>../../../ParlAI/data/models/convai2/profilememory/profilememory.txt
