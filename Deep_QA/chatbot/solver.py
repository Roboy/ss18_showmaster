...
class Solver(object):
    ...
    def __init__(self, model, sess, args, textData, globStep, writer):
        """
    ...
    def train(self):
        ...
        ####   TRAIN MODEL ###  (incl. keyboard interrupt)
        try:  # If the user exit while training, we still try to save the model
            for e in range(self.args.numEpochs):
                ...
                for nextBatch in tqdm(batches, desc="Training"):
                    ...
                    self.globStep += 1
                    #train_acc = self.calc_accuracy(feedDict, nextBatch.targetSeqs)
                    ...
                    if self.globStep % 100 == 0:
                        ...
                        # tqdm.write("----- Step %d -- Loss %.2f -- Perplexity %.2f -- Test-Acc %.2f" % (self.globStep, loss, perplexity, test_acc))
...
#    def calc_accuracy(self, feedDict, nextBatch.targetSeqs):
#        """
